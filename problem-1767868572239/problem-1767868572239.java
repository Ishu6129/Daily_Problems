// Last updated: 08/01/2026, 16:06:12
1class Solution {
...
14        int tk=nums1[i]*nums2[j]+Math.max(0,find(nums1,nums2,i+1,j+1,dp));
15        int npk1=find(nums1,nums2,i+1,j,dp);
16        int npk2=find(nums1,nums2,i,j+1,dp);
17        return dp[i][j]=Math.max(tk,Math.max(npk1,npk2));
18    }
19}